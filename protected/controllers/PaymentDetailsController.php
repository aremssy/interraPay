...
class PaymentDetailsController extends Controller
{
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['PaymentDetails']))
			$model->attributes=$_GET['PaymentDetails'];
	...
	{
		$model=PaymentDetails::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PaymentDetails $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='payment-details-form')
		{
